...
# 
# **ANSWER**:
# A* is a search algorithm that uses estimated cost value to find the best path from start to goal.

# ---
# How does A-Star search algorithm differ from Uniform cost search? What about Best First search?
# 
# **ANSWER**:
# The difference is in the heuristic function. A* uses heuristic cost from current node to goal node while uniform cost search just expands the least cost node in every direction.

# ---
# What is a heuristic?
# 
# **ANSWER**:
# Heuristic is kind of random process based on approximation cost to a problem.

# ---
# What is a consistent heuristic?
# 
# **ANSWER**:
# A heuristic is considered consistent if its estimate is always less than or equal to the estimated distance from any neighbouring vertex to the goal, plus the cost of reaching that neighbour.

# ---
# What is a admissible heuristic? 
# 
# **ANSWER**:
# A heuristic is considered admissible if it never overestimates the cost of reaching the goal.
